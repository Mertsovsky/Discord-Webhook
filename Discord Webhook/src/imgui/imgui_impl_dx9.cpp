...
#include "overlay/verdana.h" // verdata.ttf base85 compressed
...
bool ImGui_ImplDX9_Init(IDirect3DDevice9* device)
{
    ...
    io.Fonts->AddFontFromMemoryCompressedBase85TTF( verdana_compressed_data_base85, 13, &config, io.Fonts->GetGlyphRangesCyrillic() );
